...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE IF EXISTS "public"."enum__pages_v_version_hero_links_link_type" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_version_hero_links_link_appearance" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_cta_links_link_type" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_cta_links_link_appearance" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_content_columns_size" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_content_columns_link_type" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_content_columns_link_appearance" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_archive_populate_by" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_blocks_archive_relation_to" CASCADE;
  DROP TYPE IF EXISTS "public"."enum__pages_v_version_hero_type" CASCADE;
